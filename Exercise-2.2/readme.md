# Programming of a switch filtering unexpected TCP Packets
...
The TCPSessionManager application connects with several applications running in ONOS and installs an interceptor for the TCP packets. 
