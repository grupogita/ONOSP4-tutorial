...
public class AppConstants {
    ...
    public static final String APP_NAME = "co.edu.udea.gita.p4-tutorial";
    public static final PiPipeconfId PIPECONF_ID = new PiPipeconfId("co.edu.udea.gita.p4-tutorial");
