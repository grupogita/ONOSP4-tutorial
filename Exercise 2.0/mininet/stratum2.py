...
# Exercise 2.0 TO-DO: Set the name of the pipeconf application.
# Hint: check the pom.xml file of the application source code directory.
DEFAULT_PIPECONF = "SETME"
STRATUM_BMV2 = 'stratum_bmv2'

# Exercise 2.0 TO-DO: Adjust the path to the output file of the compilation
# process.
STRATUM_INIT_PIPELINE = 'SETME'
...
class StratumBmv2Switch(Switch):
    ...
    # Exercise 2.0 TO-DO (Optional): You might want to adjust the loglevel of the 
    # stratum_bmv2 switch. 
    # Check the documentation or the output of the --help option of the stratum_bmv2 
    # command
